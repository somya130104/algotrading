...
export default function App() {
  ...
  const handleDeployBot = () => {
    alert("Deploying bot sequence initiated. This connects to your trading broker API...");
  };
      ...
      <main className="flex-1 overflow-y-auto p-4 md:p-8 custom-scrollbar">
        <header className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-4">
            ...
            <button onClick={handleDeployBot} className="px-5 py-2.5 bg-gradient-to-r from-[#D62828] to-[#F77F00] text-white text-sm font-bold rounded-xl hover:shadow-[0_4px_20px_0_rgba(214,40,40,0.4)] transition-all flex items-center gap-2">
